...
class HiddenDependents
{
    ...
    protected function getPreparedSelectedValues()
    {
        ...
        foreach ($this->selectedValues as $selectedValue) {
            ...
            $data[$this->valueToOptionMap[$selectedValue]][] = $selectedValue;
        }
        return $data;
    }

    /**
     * Calculate ShareableLink hidden dependents
     *
     ...
     * @return void
     */
    public function calculateShareableLinkHiddenDependents($product, $preselectedValues)
    {
        $this->data = [
            'hidden_options'     => [],
            'hidden_values'      => [],
